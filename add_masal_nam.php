	...
	if( isset($_FILES["csv"])){
		...
		if($ext === 'csv'){
			...
			while(($ambil = fgetcsv($csv,1000,',')) !== FALSE){
				...
				$query = mysqli_query($kon,"INSERT INTO datapostpaid.user_alert_E2A (msisdn, nama, grup, STATUS, email, fungsi)VALUES('$nilai[1]', '$nilai[2]', 'auto_collection','1', '$nilai[3]', '$nilai[4]')");
			}
