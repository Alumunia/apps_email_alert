...
//error_reporting(0);
	...
	$fungsi2 = $_POST['fungsi2'];
	  ...
	  if($msisdn2 == "") {
		$ubah = mysqli_query($kon, "UPDATE `user_alert` SET  `nama`='$name2', `status`='$status2' , `email`='$email2', `fungsi`='$fungsi2' WHERE  nama='$name' && email='$email' && fungsi='$fungsi'  ");	
		
	}
	  else {
		$ubah = mysqli_query($kon, "UPDATE `user_alert` SET `msisdn`=$msisdn2 , `nama`='$name2', `status`='$status2' , `email`='$email2', `fungsi`='$fungsi2' WHERE msisdn= '$msisdn' && nama='$name' && email='$email' && fungsi='$fungsi'  ");	
