...
INSERT INTO datapostpaid.user_alert (msisdn, nama, grup, STATUS, email, fungsi)VALUES('$msisdn', '$nama', 'auto_collection','1', '$email', '$fungsi')");
            ...
            <script> document.location.href='data_mng.php#main'</script>
			<?php
            };
